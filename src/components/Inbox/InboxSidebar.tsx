...
const InboxSidebar = ({
  ...
  return (
    <div className="w-64 bg-base-100 border-r border-base-200">
      <div className="p-4">
        ...
        <div className="mb-2">
          <button
            ...
            className="flex items-center w-full text-left px-2 py-1 text-sm font-medium hover:bg-base-200 rounded-lg"
          >
          ...
          {expandedSections.all && (
            <div className="ml-4">
              {DEFAULT_ALL_FILTERS.map((filter) => (
                <button
                  key={filter.name}
                  className={`flex items-center justify-between w-full px-4 py-1 text-sm hover:bg-base-200 ${
                ...
                >
                  <span className="flex items-center">
                    <filter.icon className={`w-4 h-4 mr-2 ${
                      isFilterActive(filter.query) ? 'text-primary' : 'text-base-content/70'
                    }`} />
